    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                <div> <a href="#" onClick={(e)=>handlePlantsClick(e)} style={styleA}>ALL PLANTS</a></div>
        ...
        {!showCart? ( //when we're on the product
            ...
            <div key={index}>
                ...
                <div className="product-list">
                    ...
                    <div className="product-card" key={plantIndex}>
                        ...
                        <button disabled={addedToCart[plant.name] ? true : false} className={addedToCart[plant.name] ? "product-button added-to-cart" : "product-button"} onClick= {()=>handleAddToCart(plant)}>
